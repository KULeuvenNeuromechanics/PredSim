function scaleContactSpheres(genericModelPath,scaledModelPath)
% This code scales:
...
contact_spheres = get_contact_spheres(scaledModelPath);
...
%%% set right conctactsphere to correct position
contact_spheres(1).location = contact_spheres(2).location;
