...
%             app.usr_height = app.default_height;
        ...
        function loadResultsTable(app)
            ...
            for i=1:length(MatFiles)
                ...
                app.tbldata{i,1} = [name_tmp2 ': ' num2str(distance_i*1e-3,'%.1f') ' km, at ' num2str(avg_v_i) ' km/h'];
...
%             E_metab = 778e3; % 778 kJ = 1 pancake
            E_metab = 1.5*2202e3; % = 150g fondant chocolate (1 pack)
            try
                load(savepath,'R');
...
%             end
    ...
    methods (Access = private)
        ...
        function startupFcn(app)
            ...
            addpath([pathRepo '\AdaptOpenSimModel'])
...
%             app.GroepEditField.Placeholder = '(Enter the name of your group)';
            ...
            app.AfstandvanvingertoptotelleboogLabel.Text = 'Distance elbow to fingertip';
            ...
            app.AfstandschoudertotelleboogEditFieldLabel.Text = 'Distance shoulder to elbow';
            ...
            app.AfstandheuptotknieEditFieldLabel.Text = 'Distance hip to knee';
            ...
            app.AfstandknietotgrondEditFieldLabel.Position = [88 294 260 42];
            app.AfstandknietotgrondEditFieldLabel.Text = 'Distance knee to ground';
            ...
            app.AfstandtussenschoudersEditFieldLabel.Text = 'Shoulder width';
...
%             app.cmLabel_9.Text = 'cm';
            ...
            app.LengtevanvoetEditFieldLabel.Text = 'Length of foot';
            ...
            app.MaaktekeningButton.Text = 'Create drawing';
            ...
            app.DeManvanVitruviusLabel.Text = 'The Vitruvian Man';
            ...
            app.StartsimulatieButton.Text = 'Start simulation';
...
%             app.NaamEditField.Placeholder = '(Name)';
            ...
            app.SpeelvideoButton.Text = 'Play video';
            ...
            app.SluitvideoButton.Text = 'Close video';
            ...
            app.NaamAfstandLabel.Text = 'Name              Distance         Speed';
            ...
            app.SnelheidSliderLabel.Text = 'Speed';
