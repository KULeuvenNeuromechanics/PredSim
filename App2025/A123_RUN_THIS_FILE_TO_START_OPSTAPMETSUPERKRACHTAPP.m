classdef A123_RUN_THIS_FILE_TO_START_OPSTAPMETSUPERKRACHTAPP < matlab.apps.AppBase
...
%             % fill these in based on your computer
    ...
    methods (Access = private)
        ...
        function SpeelvideoButtonPushed(app, event)
           ...
           if strcmp(app.ModelName,'Reus')
              app.sel_osim_file = fullfile(pathRepo,'OCP\Reus.osim');
              mot_folder = fullfile(pathRepo,'OCP\Reus_v1.mot');
           elseif strcmp(app.ModelName,'Smurf')
              app.sel_osim_file = fullfile(pathRepo,'OCP\Smurf.osim');
              mot_folder = fullfile(pathRepo,'OCP\Smurf_v1.mot');
           else             
             ...
             mot_folder = fullfile(app.path_savefolder ,app.GroupName);
                 ...
                 mot_folder = fullfile(app.path_savefolder ,app.GroupName,app.ModelName);
             end
    ...
    methods (Access = public)
        ...
        % Construct app
        function app = A123_RUN_THIS_FILE_TO_START_OPSTAPMETSUPERKRACHTAPP
