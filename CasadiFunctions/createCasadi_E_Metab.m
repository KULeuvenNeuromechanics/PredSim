...
% Bhargava et al. (2004)
if S.metabolicE.includeStrengthInEnergetics
    [energy_total_sm_SX,Adot_sm_SX,Mdot_sm_SX,Sdot_sm_SX,Wdot_sm_SX,...
        energy_model_sm_SX] = getMetabolicEnergySmooth2004all_inclStrength(exc_SX,act_SX,...
        lMtilde_SX,vM_SX,Fce_SX,Fpass_SX,musclemass_SX,pctst_SX,Fiso_SX,...
        FMo,modelmass_SX,b_SX,[model_info.muscle_info.parameters.muscle_strength]');
else
    [energy_total_sm_SX,Adot_sm_SX,Mdot_sm_SX,Sdot_sm_SX,Wdot_sm_SX,...
