function [fgetMetabolicEnergySmooth2004all, fgetMetabolicEnergySmooth2016all, fgetMetabolicEnergyMargaria] = createCasadi_E_Metab(S,model_info)
% --------------------------------------------------------------------------
...
lMo = struct_array_to_double_array(model_info.muscle_info.parameters,'lMo'); % does this exist?
vcemax = 10; % OpenSim default, need to get from somewhere
...
[energy_total_sm_SX,Adot_sm_SX,Mdot_sm_SX,Sdot_sm_SX,Wdot_sm_SX,...
    ...
    lMtilde_SX,vM_SX,lMo, Fce_SX, Fpass_SX, musclemass_SX,pctst_SX,vcemax,Fiso_SX,...
    modelmass_SX,b_SX, [model_info.muscle_info.parameters.muscle_strength]');
...
% Margaria
[energy_total_sm_SX,Adot_sm_SX,Mdot_sm_SX,Sdot_sm_SX,Wdot_sm_SX,...
    energy_model_sm_SX] = getMetabolicEnergyMargaria(exc_SX,act_SX,...
    lMtilde_SX,vM_SX,lMo, Fce_SX, Fpass_SX, musclemass_SX,pctst_SX,vcemax,Fiso_SX,...
    modelmass_SX,b_SX, [model_info.muscle_info.parameters.muscle_strength]');

fgetMetabolicEnergyMargaria = ...
    Function('fgetMetabolicEnergyMargaria',...
    {exc_SX,act_SX,lMtilde_SX,vM_SX,Fce_SX,Fpass_SX,musclemass_SX,...
    pctst_SX,Fiso_SX,modelmass_SX,b_SX},{energy_total_sm_SX,...
    Adot_sm_SX,Mdot_sm_SX,Sdot_sm_SX,Wdot_sm_SX,energy_model_sm_SX});
