...
% Date: 12/19/2018
%
function [bounds,scaling] = getBounds_all_mtp_tracking(Qs,NMuscle,nq,jointi,v_tgt,GRF)
...
% Pelvis_tx
bounds.Qs.upper(jointi.pelvis.tx) = 10;  
bounds.Qs.lower(jointi.pelvis.tx) = -10;
% Pelvis_ty
bounds.Qs.upper(jointi.pelvis.ty) = 1.1;  
bounds.Qs.lower(jointi.pelvis.ty) = 0.75;
% Pelvis_tz
bounds.Qs.upper(jointi.pelvis.tz) = -10;
bounds.Qs.lower(jointi.pelvis.tz) = 10;
% Mtp
