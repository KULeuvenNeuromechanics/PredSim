...
% muscle variable and the arm variables. The final time is based on the
% experimental data.
%
% Author: Antoine Falisse
% Date: 12/19/2018
% 
function guess = getGuess_DI_mtp_t(Qs,nq,N,time_IC,NMuscle,jointi,scaling)
