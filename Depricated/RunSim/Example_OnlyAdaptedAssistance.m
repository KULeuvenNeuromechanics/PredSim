...
S.savename      = 'Actie_OnlyAdaptedAssitance_T1';
S.DataSet       = 'Poggensee_2020_Subj2_T1';        % first torque profile
f_PredSim_Gait92(S);     % run the optimization
f_LoadSim_Gait92(S.ResultsFolder,S.savename) % post-proces simulation results


S.savename      = 'Actie_OnlyAdaptedAssitance_T2';
S.DataSet       = 'Poggensee_2020_Subj2_T2';        % first torque profile
f_PredSim_Gait92(S);     % run the optimization
f_LoadSim_Gait92(S.ResultsFolder,S.savename) % post-proces simulation results