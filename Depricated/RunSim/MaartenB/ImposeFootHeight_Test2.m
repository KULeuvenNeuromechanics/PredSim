...
% savename
S.savename   =  'Sedgeford_Mean_tf_FootHeight_test2';
...
S.Constr.FootHeight.Vx_Treshold = 5; % minimal forward velocity of the foot when constraint on footheight is applied
