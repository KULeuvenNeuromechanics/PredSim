...
% output folder
S.ResultsFolder = 'BatchSim_2020_03_12_DefaultSubj_b';
...
PlotResults_3DSim(fullfile(dPath,S.ResultsFolder,[S.loadname '_pp.mat']),[0 0 0],S.loadname);
...
S.DataSet       = 'PoggenSee2020_AFO';
% f_LoadSim_PoggenSee2020_DefaultS(S.ResultsFolder,S.loadname);
PlotResults_3DSim(fullfile(dPath,S.ResultsFolder,[S.loadname '_pp.mat']),[0 0 1],S.loadname,gcf);
...
for j = 1:length(AVect)
    ...
    S.DataSet       = 'PoggenSee2020_AFO';
%     f_LoadSim_PoggenSee2020_DefaultS(S.ResultsFolder,S.loadname);
    PlotResults_3DSim(fullfile(dPath,S.ResultsFolder,[S.loadname '_pp.mat']),ColVect(j,:),S.loadname,gcf);
end
