...
2. **Edit** the source file (`PUBLICATIONS.rst`_) and add your publication to the list below.
3. Use the `APA reference style <https://apastyle.apa.org/style-grammar-guidelines/references/examples>`__. Please do add the DOI or URL.
4. **Submit a pull request** with your addition.
5. Congrats, you are now a contributor to PredSim! 

.. _PUBLICATIONS.rst: https://github.com/KULeuvenNeuromechanics/PredSim/blob/master/Documentation/source/PUBLICATIONS.rst

Publications using PredSim
--------------------------

2025
""""
.. _[Van Den Bosch 2025]:
