...
S.misc.save_folder  = fullfile(pathExDir,'ExampleResults','PelvisForce');  
...
fext.function_name = 'Fext_pelvis_emg';
fext.muscle_names = {'tib_ant_r','tib_ant_l'};

fext.extForce = [100, 0, 0]';
fext.r_origin = [0, 0, 0]';
