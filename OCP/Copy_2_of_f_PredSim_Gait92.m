...
if testing==1
    import casadi.*
load muscle_spanning_joint_info
load muscleInfo
load muscleData
[~,mai] = MomentArmIndices_asym(muscleNames,muscle_spanning_joint_info);
...
f_casadi.f_lMT_vMT_dM = Function('f_lMT_vMT_dM',{qin,qdotin},{lMT,vMT,dM});
end
