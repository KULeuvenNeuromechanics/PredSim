...
R.metabolics.Uchida2016.Mdot = zeros(N,NMuscle);
...
for i=1:N
    [Edot_tot_i,Adot_i,Mdot_i,Sdot_i,Wdot_i,Edot_b_i] = f_casadi.getMetabolicEnergySmooth2016all(...
            R.muscles.a(i,:)',R.muscles.a(i,:)',R.muscles.lMtilde(i,:)',R.muscles.vM(i,:)',...
            R.muscles.Fce(i,:)',R.muscles.Fpass(i,:)',MuscleMass',pctsts,R.muscles.Fiso(i,:)',...
            R.misc.body_mass,R.S.metabolicE.tanh_b);
    ...
    R.metabolics.Uchida2016.Mdot(i,:) = full(Mdot_i)';
