function [R] = PostProcess_spatio_temporal(S,model_info,f_casadi,R)
% --------------------------------------------------------------------------
...
if isfield(f_casadi,'f_getStepLength')
    [step_length_r,step_length_l] = f_casadi.f_getStepLength(R.kinematics.Qs_rad(1,:),R.kinematics.Qs_rad(end,:));
...
R.ground_reaction.idx_double_support = intersect(R.ground_reaction.idx_stance_r,R.ground_reaction.idx_stance_l);
