function [R] = PostProcessing_initialGuess(S,model_info,f_casadi, initGuess)
% --------------------------------------------------------------------------
% PostProcessing
...
R.S = S;
R.model_info = model_info;
R.kinematics = initGuess;
...
R.kinematics.Qddots_rad = R.kinematics.Qdotdots;
R.kinematics.Qddots_rad(:,model_info.ExtFunIO.jointi.rotations) = ...
    R.kinematics.Qdotdots(:,model_info.ExtFunIO.jointi.rotations)*pi/180;
...
% Evaluate the ligament lengths and ofrces 
    [R] = PostProcess_ligament_geometry(model_info, f_casadi,R);
end
