...
int F_generic(const T** arg, T** res) {
	...
	OpenSim::Body* pelvis;
	pelvis = new OpenSim::Body("pelvis", 9.71433360917239951959, Vec3(-0.06827779999999999960, 0.00000000000000000000, 0.00000000000000000000), Inertia(0.08149289999999999312, 0.08149289999999999312, 0.04454280000000000045, 0., 0., 0.));
	model->addBody(pelvis);

	OpenSim::Body* femur_r;
	femur_r = new OpenSim::Body("femur_r", 7.67231915023828037192, Vec3(0.00000000000000000000, -0.17046700000000000741, 0.00000000000000000000), Inertia(0.11105500000000000094, 0.02911160000000000136, 0.11711000000000000576, 0., 0., 0.));
	model->addBody(femur_r);

	OpenSim::Body* tibia_r;
	tibia_r = new OpenSim::Body("tibia_r", 3.05815503574820990451, Vec3(0.00000000000000000000, -0.18048900000000001054, 0.00000000000000000000), Inertia(0.03885269999999999696, 0.00393151999999999998, 0.03939229999999999815, 0., 0., 0.));
	model->addBody(tibia_r);

	OpenSim::Body* talus_r;
	talus_r = new OpenSim::Body("talus_r", 0.08248563818606099995, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Inertia(0.00068896799999999998, 0.00068896799999999998, 0.00068896799999999998, 0., 0., 0.));
	model->addBody(talus_r);

	OpenSim::Body* calcn_r;
	calcn_r = new OpenSim::Body("calcn_r", 1.03107047732575995980, Vec3(0.09139239999999999864, 0.02741769999999999971, 0.00000000000000000000), Inertia(0.00096455499999999997, 0.00268696999999999990, 0.00282476999999999989, 0., 0., 0.));
	model->addBody(calcn_r);

	OpenSim::Body* toes_r;
	toes_r = new OpenSim::Body("toes_r", 0.17866389231100798796, Vec3(0.03162179999999999852, 0.00548355000000000023, -0.01599369999999999958), Inertia(0.00006889680000000000, 0.00013779400000000000, 0.00006889680000000000, 0., 0., 0.));
	model->addBody(toes_r);

	OpenSim::Body* femur_l;
	femur_l = new OpenSim::Body("femur_l", 7.67231915023828037192, Vec3(0.00000000000000000000, -0.17046700000000000741, 0.00000000000000000000), Inertia(0.11105500000000000094, 0.02911160000000000136, 0.11711000000000000576, 0., 0., 0.));
	model->addBody(femur_l);

	OpenSim::Body* tibia_l;
	tibia_l = new OpenSim::Body("tibia_l", 3.05815503574820990451, Vec3(0.00000000000000000000, -0.18048900000000001054, 0.00000000000000000000), Inertia(0.03885269999999999696, 0.00393151999999999998, 0.03939229999999999815, 0., 0., 0.));
	model->addBody(tibia_l);

	OpenSim::Body* talus_l;
	talus_l = new OpenSim::Body("talus_l", 0.08248563818606099995, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Inertia(0.00068896799999999998, 0.00068896799999999998, 0.00068896799999999998, 0., 0., 0.));
	model->addBody(talus_l);

	OpenSim::Body* calcn_l;
	calcn_l = new OpenSim::Body("calcn_l", 1.03107047732575995980, Vec3(0.09139239999999999864, 0.02741769999999999971, 0.00000000000000000000), Inertia(0.00096455499999999997, 0.00268696999999999990, 0.00282476999999999989, 0., 0., 0.));
	model->addBody(calcn_l);

	OpenSim::Body* toes_l;
	toes_l = new OpenSim::Body("toes_l", 0.17866389231100798796, Vec3(0.03162179999999999852, 0.00548355000000000023, 0.01599369999999999958), Inertia(0.00006889680000000000, 0.00013779400000000000, 0.00006889680000000000, 0., 0., 0.));
	model->addBody(toes_l);

	OpenSim::Body* torso;
	torso = new OpenSim::Body("torso", 28.24027800320899928010, Vec3(-0.02897220000000000004, 0.30903700000000000614, 0.00000000000000000000), Inertia(1.14043999999999989825, 0.59340099999999995628, 1.14043999999999989825, 0., 0., 0.));
	model->addBody(torso);
	...
	hip_r = new OpenSim::PinJoint("hip_r", *pelvis, Vec3(-0.06827779999999999960, -0.06383540000000000048, 0.08233070000000000666), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *femur_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000));

	OpenSim::PinJoint* knee_r;
	knee_r = new OpenSim::PinJoint("knee_r", *femur_r, Vec3(-0.00451221000000000001, -0.39690700000000000980, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *tibia_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000));

	OpenSim::PinJoint* ankle_r;
	ankle_r = new OpenSim::PinJoint("ankle_r", *tibia_r, Vec3(0.00000000000000000000, -0.41569499999999998119, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *talus_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000));

	OpenSim::WeldJoint* subtalar_r;
	subtalar_r = new OpenSim::WeldJoint("subtalar_r", *talus_r, Vec3(-0.04457210000000000338, -0.03833910000000000096, 0.00723827999999999971), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *calcn_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000));
	...
	hip_l = new OpenSim::PinJoint("hip_l", *pelvis, Vec3(-0.06827779999999999960, -0.06383540000000000048, -0.08233070000000000666), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *femur_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000));

	OpenSim::PinJoint* knee_l;
	knee_l = new OpenSim::PinJoint("knee_l", *femur_l, Vec3(-0.00451221000000000001, -0.39690700000000000980, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *tibia_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000));

	OpenSim::PinJoint* ankle_l;
	ankle_l = new OpenSim::PinJoint("ankle_l", *tibia_l, Vec3(0.00000000000000000000, -0.41569499999999998119, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *talus_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000));

	OpenSim::WeldJoint* subtalar_l;
	subtalar_l = new OpenSim::WeldJoint("subtalar_l", *talus_l, Vec3(-0.04457210000000000338, -0.03833910000000000096, -0.00723827999999999971), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *calcn_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000));

	OpenSim::WeldJoint* mtp_l;
	mtp_l = new OpenSim::WeldJoint("mtp_l", *calcn_l, Vec3(0.16340999999999999970, -0.00182785000000000000, -0.00098703799999999998), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *toes_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000));

	OpenSim::PinJoint* back;
	back = new OpenSim::PinJoint("back", *pelvis, Vec3(-0.09725000000000000311, 0.07870779999999999443, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *torso, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000));
	...
	Vec3 SmoothSphereHalfSpaceForce_s1_r_location(0.03130752758193179608, 0.01043584252731059869, 0.00000000000000000000);
	...
	SmoothSphereHalfSpaceForce_s1_r->set_contact_half_space_orientation(Vec3(0.00000000000000000000, 0.00000000000000000000, -1.57000000000000006217));
	SmoothSphereHalfSpaceForce_s1_r->set_stiffness(3067776.00000000000000000000);
	...
	Vec3 SmoothSphereHalfSpaceForce_s2_r_location(0.17740932296428019166, -0.01565376379096589804, 0.00521792126365529935);
	SmoothSphereHalfSpaceForce_s2_r->set_contact_sphere_location(SmoothSphereHalfSpaceForce_s2_r_location);
	double SmoothSphereHalfSpaceForce_s2_r_radius = (0.01499999999999999944);
	...
	SmoothSphereHalfSpaceForce_s2_r->set_contact_half_space_orientation(Vec3(0.00000000000000000000, 0.00000000000000000000, -1.57000000000000006217));
	SmoothSphereHalfSpaceForce_s2_r->set_stiffness(3067776.00000000000000000000);
	...
	Vec3 SmoothSphereHalfSpaceForce_s1_l_location(0.03130752758193179608, 0.01043584252731059869, -0.00000000000000000000);
	...
	SmoothSphereHalfSpaceForce_s1_l->set_contact_half_space_orientation(Vec3(0.00000000000000000000, 0.00000000000000000000, -1.57000000000000006217));
	SmoothSphereHalfSpaceForce_s1_l->set_stiffness(3067776.00000000000000000000);
	...
	Vec3 SmoothSphereHalfSpaceForce_s2_l_location(0.17740932296428019166, -0.01565376379096589804, -0.00521792126365529935);
	SmoothSphereHalfSpaceForce_s2_l->set_contact_sphere_location(SmoothSphereHalfSpaceForce_s2_l_location);
	double SmoothSphereHalfSpaceForce_s2_l_radius = (0.01499999999999999944);
	...
	SmoothSphereHalfSpaceForce_s2_l->set_contact_half_space_orientation(Vec3(0.00000000000000000000, 0.00000000000000000000, -1.57000000000000006217));
	SmoothSphereHalfSpaceForce_s2_l->set_stiffness(3067776.00000000000000000000);
	...
	Array<osim_double_adouble> Force_2 = SmoothSphereHalfSpaceForce_s1_l->getRecordValues(*state);
	SpatialVec GRF_2;
	GRF_2[0] = Vec3(Force_2[3], Force_2[4], Force_2[5]);
	GRF_2[1] = Vec3(Force_2[0], Force_2[1], Force_2[2]);
	int c_idx_2 = model->getBodySet().get("calcn_l").getMobilizedBodyIndex();
	appliedBodyForces[c_idx_2] += GRF_2;

	Array<osim_double_adouble> Force_3 = SmoothSphereHalfSpaceForce_s2_l->getRecordValues(*state);
	SpatialVec GRF_3;
	...
	Vec3 locationCP_G_adj_2 = SmoothSphereHalfSpaceForce_s1_l_locationCP_G - 0.5*SmoothSphereHalfSpaceForce_s1_l_locationCP_G[1] * normal;
	Vec3 SmoothSphereHalfSpaceForce_s1_l_locationCP_B = model->getGround().findStationLocationInAnotherFrame(*state, locationCP_G_adj_2, *calcn_l);
	Vec3 GRM_2 = (TR_GB_calcn_l*SmoothSphereHalfSpaceForce_s1_l_locationCP_B) % GRF_2[1];
	GRM_l = GRM_2;
	...
	Vec3 locationCP_G_adj_3 = SmoothSphereHalfSpaceForce_s2_l_locationCP_G - 0.5*SmoothSphereHalfSpaceForce_s2_l_locationCP_G[1] * normal;
	Vec3 SmoothSphereHalfSpaceForce_s2_l_locationCP_B = model->getGround().findStationLocationInAnotherFrame(*state, locationCP_G_adj_3, *calcn_l);
	Vec3 GRM_3 = (TR_GB_calcn_l*SmoothSphereHalfSpaceForce_s2_l_locationCP_B) % GRF_3[1];
	GRM_l += GRM_3;
	...
	osim_double_adouble P_HC_y_2 = SmoothSphereHalfSpaceForce_s1_l_velocity_G[1]*GRF_2[1][1];
	...
	osim_double_adouble P_HC_y_3 = SmoothSphereHalfSpaceForce_s2_l_velocity_G[1]*GRF_3[1][1];
	/// Outputs.
	...
	/// Ground reaction moments.
	for (int i = 0; i < 3; ++i) res[0][i + NU + 18] = value<T>(GRM_r[1][i]);
	for (int i = 0; i < 3; ++i) res[0][i + NU + 21] = value<T>(GRM_l[1][i]);
	/// Contact spheres deformation power.
	res[0][NU + 24] = value<T>(P_HC_y_0);
	res[0][NU + 25] = value<T>(P_HC_y_1);
	res[0][NU + 26] = value<T>(P_HC_y_2);
	res[0][NU + 27] = value<T>(P_HC_y_3);
