...
int F_generic(const T** arg, T** res) {
	...
	OpenSim::WeldJoint* elbow_r;
	elbow_r = new OpenSim::WeldJoint("elbow_r", *humerus_r, Vec3(0.01425203920000000027, -0.31040581389999999384, -0.01040385849999999994), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.50000000000000000000), *ulna_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000));

	OpenSim::WeldJoint* elbow_l;
	elbow_l = new OpenSim::WeldJoint("elbow_l", *humerus_l, Vec3(0.01425203920000000027, -0.31040581389999999384, 0.01040385849999999994), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.50000000000000000000), *ulna_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000));
	...
	Vec3 contactHeel_r_location(0.01000000000000000021, 0.00000000000000000000, 0.00000000000000000000);
	...
	Vec3 contactHeel_l_location(0.01000000000000000021, 0.00000000000000000000, 0.00000000000000000000);
	...
	double contactFront_r_radius = (0.01400000000000000029);
	...
	double contactFront_l_radius = (0.01400000000000000029);
