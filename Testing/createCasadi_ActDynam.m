...
e_a = SX.sym('e_a',model_info.ExtFunIO.nq.arms); % arm excitations
a_a = SX.sym('a_a',model_info.ExtFunIO.nq.arms); % arm activations
...
e_lumb = SX.sym('e_a',model_info.ExtFunIO.nq.torso); % Lumbar excitations
a_lumb = SX.sym('a_a',model_info.ExtFunIO.nq.torso); % Lumbar activations
...
e_mtp = SX.sym('e_mtp',model_info.ExtFunIO.nq.mtp); % mtp excitations
a_mtp = SX.sym('a_mtp',model_info.ExtFunIO.nq.mtp); % mtp activations
