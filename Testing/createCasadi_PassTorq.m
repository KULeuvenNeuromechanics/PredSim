...
Qdot_SX = SX.sym('Qdot_SX',model_info.ExtFunIO.nq.all,1); % Muscle activations
...
for i=1:model_info.ExtFunIO.nq.legs_nomtp
...
for i=1:model_info.ExtFunIO.nq.torso
...
%   coord_muscleActuated(i)
    ...
    Q_SX(model_info.ExtFunIO.jointi.muscleActuated(i)),...
...
Tau_passj_mtp = [];
for i=1:model_info.ExtFunIO.nq.mtp
%    mtpi(i)
