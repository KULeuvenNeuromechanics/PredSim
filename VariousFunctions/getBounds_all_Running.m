...
%
%--------------------------------------------------------------------------
function [bounds,scaling] = getBounds_all_Running(Qs,model_info,S)
...
% floating base tx
bounds.Qs.upper(model_info.ExtFunIO.jointi.floating_base(4)) = 6;  
...
if S.subject.v_pelvis_x_trgt > 1.33
    ...
    % Pelvis tx
    bounds.Qdots.upper(model_info.ExtFunIO.jointi.floating_base(4)) = 6;
end
