...
S.sim_name = 'Syn_2R_2L_HalfCycle_trackWeightsPitto2020';
...
Pitto2020_2Syn = [0.28 0.86 0.68 0.52 0.2 1 0.84 0.6;...
    0.76 0.2 0.2 0.22 1 0.1 0.04 0.06]; % 
S.knownSynW = [Pitto2020_2Syn(:,1),...
    Pitto2020_2Syn(:,2),...
    Pitto2020_2Syn(:,3),Pitto2020_2Syn(:,3),...
    Pitto2020_2Syn(:,4),Pitto2020_2Syn(:,4),...
    Pitto2020_2Syn(:,5),...
    Pitto2020_2Syn(:,6),Pitto2020_2Syn(:,6),...
    Pitto2020_2Syn(:,7),...
    Pitto2020_2Syn(:,8),Pitto2020_2Syn(:,8),Pitto2020_2Syn(:,8)]';
