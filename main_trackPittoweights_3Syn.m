...
S.NSyn_r = 3;
S.NSyn_l = 3; % if half cycle (symmetric) should be the same as NSyn_l
...
S.sim_name = 'Syn_3R_3L_HalfCycle_trackWeightsPitto2020';
...
Pitto2020_3Syn = [0.2 0.55 0.08 0 0 1 0.8 0.4;...
    0.65 0.23 0 0.03 1 0 0.03 0.05;...
    0 0.32 1 0.98 0.12 0.06 0 0.4]; % 
S.knownSynW = [Pitto2020_3Syn(:,1),...
    Pitto2020_3Syn(:,2),...
    Pitto2020_3Syn(:,3),Pitto2020_3Syn(:,3),...
    Pitto2020_3Syn(:,4),Pitto2020_3Syn(:,4),...
    Pitto2020_3Syn(:,5),...
    Pitto2020_3Syn(:,6),Pitto2020_3Syn(:,6),...
    Pitto2020_3Syn(:,7),...
    Pitto2020_3Syn(:,8),Pitto2020_3Syn(:,8),Pitto2020_3Syn(:,8)]';
